...
class StockingEventFilter(django_filters.FilterSet):
    ...
    lake = ValueInFilter(
        field_name='jurisdiction__lake__abbrev', lookup_expr='in')
    ...
    strain = NumberInFilter(
        field_name='strain_raw__strain__id', lookup_expr='in')
    ...
    jurisdiction = ValueInFilter(
        field_name='jurisdiction__slug', lookup_expr='in')

    mark = ValueInFilter(field_name='mark', lookup_expr='in')
    mark_like = django_filters.CharFilter(
        field_name='mark', lookup_expr='icontains')
    ...
    class Meta:
        ...
        fields = [
            ...
            'jurisdiction__lake__abbrev', 'jurisdiction__slug',
            'stocking_method__stk_meth', 'mark'
        ]
