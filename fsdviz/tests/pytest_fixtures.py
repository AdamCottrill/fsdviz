...
reused_cwt_parameters = [
    ...
    (
        ...
        [("5555", "551111"), ("5555b", "551111"), ("7777", "")],
        None,
    ),
    (
        {"multiple_yearclasses": True},
        [("5555", "551111"), ("5555b", "551111")],
        [
            ("1111", "111111"),
            ("2222", "111111"),
            ("3333", "333333"),
    ...
    (
        ...
        [("5555", "551111"), ("5555b", "551111"), ("6666", "111166"), ("7777", "")],
        None,
    ),
    (
    ...
    (
        {"multiple_strains": True},
        [("3333", "333333"), ("3333b", "333333"), ("4444", "333333")],
        [
            ("1111", "111111"),
            ("2222", "111111"),
            ("5555", "551111"),
    ...
    (
        ...
        [("3333", "333333"), ("3333b", "333333"), ("4444", "333333"), ("7777", "")],
        None,
    ),
    (
        {"cwt_number_like": "1111"},
    ...
    (
        {"cwt_number": "551111,111166"},
        [("5555", "551111"), ("5555b", "551111"), ("6666", "111166")],
        [
            ("1111", "111111"),
            ("2222", "111111"),
            ("3333", "333333"),
    ...
    (
        {"lake": "HU"},
        [("1111", "111111"), ("2222", "111111"), ("5555b", "551111")],
        [
            ("3333", "333333"),
            ("3333b", "333333"),
            ("4444", "333333"),
    ...
    (
        ...
        [("4444", "333333"), ("2222", "111111"), ("7777", "")],
        "events__agency",
    ),
    (
        {"agency": "ODNR,MDNR"},
        [("4444", "333333"), ("2222", "111111")],
        [
            ("1111", "111111"),
            ("3333", "333333"),
            ("3333b", "333333"),
    ...
    (
        ...
        [("2222", "111111"), ("4444", "333333"), ("7777", "")],
        "events__jurisdiction__stateprov",
    ),
    (
        {"stateprov": "MI,OH"},
        [("2222", "111111"), ("4444", "333333")],
        [
            ("1111", "111111"),
            ("3333", "333333"),
            ("3333b", "333333"),
    ...
    (
        {"jurisdiction": "hu_on, er_oh"},
        [("1111", "111111"), ("4444", "333333"), ("5555b", "551111")],
        [
            ("2222", "111111"),
            ("3333", "333333"),
            ("3333b", "333333"),
    ...
    (
        {"stocking_month": "4,99"},
        [("1111", "111111"), ("3333", "333333"), ("3333b", "333333")],
        [
            ("2222", "111111"),
            ("4444", "333333"),
            ("5555", "551111"),
    ...
    (
        ...
        [("2222", "111111"), ("4444", "333333"), ("6666", "111166"), ("7777", "")],
        "events__species",
    ),
    (
        {"species": "RBT,COS"},
        [("2222", "111111"), ("4444", "333333"), ("6666", "111166")],
        [
            ("1111", "111111"),
            ("3333", "333333"),
            ("3333b", "333333"),
    ...
    (
        {"stocking_method": "b"},
        [("2222", "111111"), ("3333", "333333"), ("3333b", "333333")],
        [
            ("1111", "111111"),
            ("4444", "333333"),
            ("6666", "111166"),
    ...
    (
        ...
        [("2222", "111111"), ("3333", "333333"), ("3333b", "333333"), ("7777", "")],
        "events__stocking_method",
    ),
    (
        {"lifestage": "y"},
    ...
    (
        {"fishtags": "FTR"},
        [("1111", "111111"), ("2222", "111111"), ("3333", "333333")],
        [
            ("3333b", "333333"),
            ("4444", "333333"),
            ("6666", "111166"),
    ...
    (
        ...
        [("1111", "111111"), ("2222", "111111"), ("4444", "333333"), ("7777", "")],
        "events__hatchery",
    ),
    (
        {"hatchery": "mnrfA,odnrA"},
        [("1111", "111111"), ("4444", "333333")],
        [
            ("2222", "111111"),
            ("3333", "333333"),
            ("3333b", "333333"),
