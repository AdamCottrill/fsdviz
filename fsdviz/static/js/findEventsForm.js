(function () {
  ...
  let species_lookup = {};
  species.forEach(d => species_lookup[d.abbrev] = `${d.common_name} (${d.abbrev})`);
  let strain_lookup = {};
  strains.forEach(d => strain_lookup[d.id] = `${d.strain_label} (${d.strain_code})`);
  let lifestage_lookup = {};
  lifestages.forEach(d => lifestage_lookup[d.id] = `${d.description} (${d.abbrev})`);
  let method_lookup = {};
